/* ===  FEEG2001 Group 11: Combined Gimbal and Logging Firmware  ===
 *
 * Pin  No.   |            Description          |
 * ==============================================
 ...
 * Pin  11    |   Yaw Servo                     |
 * Pin  12    |   DMP Initialisation Status     |
 * Pin  13    |   MPU Status                    |
 * Pin  A4    |   MPU SDA                       |
 * Pin  A5    |   MPU SCL                       |
 */
...
// === Gimbal Implementation ===
    ...
    uint32_t m = millis();
    float dataArray[7] = {m, ypr[0], ypr[1], ypr[2], aaReal.x, aaReal.y, aaReal.z};
    String logString = "";
